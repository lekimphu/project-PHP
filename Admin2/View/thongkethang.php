<meta charset="UTF-8">
        ...
        <div class="pt-5">
          ...
          <span>Thống Kê Từ </span><input type="month" name="mothn" id=""> đến nay <button type="submit">Submit</button>
        </form>
        </div>
    ...
    google.setOnLoadCallback(function() {
      drawVisualization(<?php if(isset($nam) && isset($thang)) echo $nam . ',' . $thang; ?>);
     });
          function drawVisualization(nam = null,thang = null) {
            ...
            if(isset($nam) && isset($thang) && isset($ngay)){
              $result = $hh->thongkeMonth($nam, $thang);
            }else{
              $result = $hh->thongkeMonth();
            }            
