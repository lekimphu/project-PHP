...
<section class="get-in-touch">
   ...
   <form action="index.php?action=khachhangtam&act=khachhangtam_action" method="post" class="contact-form row">
      <div class="form-field col-lg-6">
         <input id="txttenkh" name="txttenkh" class="input-text js-input" type="text" required>
         <label class="label" for="txttenkh">Tên</label>
      </div>
      <div class="form-field col-lg-6 ">
      ...
      <div class="form-field col-lg-6 ">
         ...
         <label class="label" for="txtdiachi">Địa chỉ</label>
      </div>
      <div class="form-field col-lg-6 ">
         <input id="txtsodt" name="txtsodt" class="input-text js-input" type="number" required>
         <label class="label" for="txtsodt">Số điện thoại</label>
      </div>
