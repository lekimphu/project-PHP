...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 23, 2023 lúc 03:26 AM
...
(13, 29, 27, '2023-03-01', ''),
(14, 1, 27, '2023-03-20', '  hello'),
(15, 1, 27, '2023-03-20', ''),
(16, 1, 27, '2023-03-20', '  hello'),
(17, 1, 27, '2023-03-20', ''),
(18, 1, 27, '2023-03-20', '  hello'),
(19, 1, 27, '2023-03-20', '');
...
CREATE TABLE `cthd` (
  ...
  `mausac` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
(114, 4, 3, 'Màu Trắng', 'Lớn', 1350000, 0),
(116, 8, 1, 'Màu Trắng', 'Lớn', 1000000, 0),
(118, 25, 1, 'Màu Trắng', 'Lớn', 900000, 0),
(120, 4, 3, 'Màu Trắng', 'Vừa', 4050000, 0),
(122, 4, 2, 'Màu Trắng', 'Vừa', 2700000, 0),
(126, 1, 2, 'Màu Trắng', 'Lớn', 600000, 0),
(130, 1, 1, 'Màu Trắng', 'Lớn', 300000, 0),
(132, 1, 3, 'Màu Trắng', 'Lớn', 900000, 0);
...
(1, 'Có Em', 300000, 0, '15.jpg', 1, 50, '2022-12-10', 'Mỗi bông hoa tượng trưng cho những tính cách khác nhau ', 'Lớn', 40, 'Màu Trắng'),
...
(114, 27, '2023-03-21', 27300000),
(116, 27, '2023-03-21', 5250000),
(118, 27, '2023-03-21', 820000),
(120, 27, '2023-03-21', 1350000),
(122, 27, '2023-03-21', 1350000),
(126, 27, '2023-03-21', 1200000),
(128, 27, '2023-03-21', 1670000),
(130, 27, '2023-03-21', 1150000),
(132, 27, '2023-03-21', 1150000);
...
(61, 'Nguyễn Văn A', 'lekimphutest4@gmail.com', 'cu chi', 51321),
(62, 'Nguyễn Văn A', 'lekimphutest4@gmail.com', 'cu chi', 51321),
(63, 'Nguyễn Văn A', 'lekimphutest4@gmail.com', 'cu chi', 51321),
(64, 'Phu  Le', 'lekimphutest1@gmail.com', 'Củ chi', 51321),
(65, 'phu1', 'lekimphutest1@gmail.com', 'cu chi', 51321),
(66, 'phu1', 'lekimphutest1@gmail.com', 'cu chi', 51321);
...
--
ALTER TABLE `hanghoa`
  MODIFY `mahh` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT cho bảng `hoadon`
--
ALTER TABLE `hoadon`
  MODIFY `masohd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
